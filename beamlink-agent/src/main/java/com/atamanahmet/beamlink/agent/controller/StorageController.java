...
import com.atamanahmet.beamlink.agent.service.StorageService;
import com.atamanahmet.beamlink.agent.service.SystemService;
...
@RestController
@RequestMapping("/api/agent/storage")
...
public class StorageController {
    ...
    public ResponseEntity<Map<String, String>> getUploadDir() {
        return ResponseEntity.ok(
                Map.of("path", storageService.getUploadsDir().toString().replace("\\", "/"))
        );
    }
